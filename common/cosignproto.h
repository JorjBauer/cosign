...
#define COSIGN_CAPA_AUTHTIME	(1<<2)
...
#define COSIGN_CONN_SUPPORTS_AUTHTIME(c) ((c)->conn_capa & COSIGN_CAPA_AUTHTIME)
...
#define COSIGN_PROTO_AUTHTIME	COSIGN_PROTO_V4
#define COSIGN_PROTO_CURRENT	COSIGN_PROTO_V4
...
#define COSIGN_PROTO_SUPPORTS_AUTHTIME(p) \
			COSIGN_PROTO_MIN_REQUIRED((p), COSIGN_PROTO_AUTHTIME)
